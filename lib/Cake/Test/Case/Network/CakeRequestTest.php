...
/**
 * Test that even if mod_rewrite is on, and the url contains index.ctp
 ...
 */
	public function testBaseUrlWithModRewriteAndExtraSlashes() {
		$_SERVER['REQUEST_URI'] = '/cakephp/webroot///index.ctp/bananas/eat';
		$_SERVER['PHP_SELF'] = '/cakephp/webroot///index.ctp/bananas/eat';
